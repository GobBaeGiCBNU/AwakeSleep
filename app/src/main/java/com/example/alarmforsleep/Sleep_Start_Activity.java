...
public class Sleep_Start_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sleep_end = (Button) findViewById(R.id.sleep_end);
        sleep_end.setOnClickListener(new View.OnClickListener(){
